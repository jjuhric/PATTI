...
// this app (memories, the active chat's messages, admin users, table rows) is already loaded
// client-side by the time the user wants to export it, so this triggers a browser download
// directly rather than adding a round trip to the server for data the page already has.
//
// monitor_dashboard/src/export.js is a duplicate of this file, not a shared import -
